...
const defaultColor = new THREE.Color("rgb(83%, 83%, 83%)");
const motionColor = {
    'G0': new THREE.Color("rgb(0%, 100%, 0%)"),
    'G1': new THREE.Color("rgb(0%, 0%, 100%)"),
    'G2': new THREE.Color("rgb(0%, 75%, 100%)"),
    'G3': new THREE.Color("rgb(0%, 75%, 100%)")
